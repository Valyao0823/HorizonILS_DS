...
import com.example.hesolutions.ils_ds.R;
...
public class WeekView extends View {
    ...
    private int mHeaderColumnTextColor = Color.rgb(19, 188, 185);
    private int mNumberOfVisibleDays = 3;
    private int mHeaderRowPadding = 10;
    private int mHeaderRowBackgroundColor = Color.WHITE;
    private int mDayBackgroundColor = Color.rgb(9, 25, 40);
    private int mPastBackgroundColor = Color.rgb(9, 25, 40);
        ...
        if (mWeekViewLoader != null){
            ...
            if (!isInEditMode() && (mFetchedPeriod < 0 || mFetchedPeriod != periodToFetch || mRefreshEvents)) {
                ...
                if (mCurrentPeriodEvents != null){
                    if (periodToFetch == mFetchedPeriod){
